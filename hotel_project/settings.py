...
SECRET_KEY = 'django-insecure-cs%z@m+kq4za%=cqdr-l8fl!$=xb5yp-7opco%_4-lmbzp-g^7'
...
INSTALLED_APPS = [
    ...
    'django.contrib.humanize',  # Tambahkan humanize ke INSTALLED_APPS
    'hotel', # Tambahkan aplikasi hotel ke INSTALLED_APPS
]
